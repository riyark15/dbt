--This fact table provides a detailed view of product pricing 
--across pricebooks, including unit prices, product metadata, and whether each price entry is active. 
