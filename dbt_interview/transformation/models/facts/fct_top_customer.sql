--This fact table provides a performance summary of top customers based on closed-won opportunities, 
--showing metrics such as total deals won, total revenue generated, average deal size, 
--and timeline of deals (first and latest).
